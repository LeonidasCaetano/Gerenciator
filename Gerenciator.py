...
while True:
    ...
    if opcao not in ["1", "2", "3", "4", "5", "6", "7", "8","10"]:
    ...
    try:
        match int(opcao):
            ...
            case 10:
                ...
                if senha=="admin123":
                    print("Modo livre ativado\nColoque tudo em uma linha de código")
                    entrada=input()
                    a=cursor.execute(entrada)
                    print(a)
...
print("Deseja exportar para um arquivo .bib (1), para word (2), para ambos (3) ou não atualizar (4)?")
